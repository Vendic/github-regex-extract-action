...
const run = async () => {
    try {
        const input_pattern = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('pattern');
        const pattern_flags = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('pattern_flags');
        ...
        _actions_core__WEBPACK_IMPORTED_MODULE_0__.info(`Found ${matches.length} matches`);
        _actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput('matches', matches.join('\n'));
    }
    catch (error) {
